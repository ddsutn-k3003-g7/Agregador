...
import ar.edu.utn.dds.k3003.service.FachadaSolicitudes;
...
public class SolicitudesProxy implements FachadaSolicitudes {
  ...
  @Override
  public void setFachadaFuente(ar.edu.utn.dds.k3003.service.FachadaFuente fuente) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'setFachadaFuente'");
  }

  @SneakyThrows
  @Override
  public List<String> obtenerHechoIdsUnicos() {
    log.info("Proxy: buscando hechos con solicitudes");
    ...
    log.info("Endpoint base: {}", this.endpoint);
    // Response<List<SolicitudDTO>> response = this.service.get(hechoId).execute();
    Call<List<String>> call = this.service.getHechos();
